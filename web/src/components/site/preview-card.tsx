...
/**
 * A showcase tile in a category gallery: a live preview + name, linking to the detail
 * page. No code is shown here (that lives on the detail page). Hover is a subtle
...
export function PreviewCard({ variant }: { variant: Variant }) {
  return (
    ...
    >
      <div className="flex min-h-[184px] flex-1 flex-wrap items-center justify-center gap-3 p-8">
        {variant.preview}
      </div>

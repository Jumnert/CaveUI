...
// Subscribe to the `.dark` class on <html> so the icon reflects the live theme without
// calling setState inside an effect (keeps the component hydration-safe and lint-clean).
function subscribeToHtmlTheme(callback: () => void) {
...
export const AnimatedThemeToggler = ({
  ...
  const docIsDark = useSyncExternalStore(
    subscribeToHtmlTheme,
    () => document.documentElement.classList.contains("dark"),
    () => false,
  );
  const isDark = isControlled ? theme === "dark" : docIsDark;

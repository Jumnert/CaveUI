...
export default function Announcement4() {
  return (
    <div className="relative isolate flex w-full items-center justify-center overflow-hidden border-b border-primary/20 bg-primary/10 px-4 py-1.5 tracking-tight">
      <div
        aria-hidden="true"
